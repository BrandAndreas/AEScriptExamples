// Verbesserungen:
// Wenn man Formen aus Texten generiert, sollte es eine zweite Möglichkeit geben, damit alle Buchstaben in einzelnen Ebenen getrennt werden.
// Umsetzungsidee:
// Kopiere die erzeugte Formen-Ebene und lösche alle Inhalte, bis auf den ersten Buchstaben und danch das gleiche mit dem zweiten Buchstaben und so weiter.
...
(function rd_BatchLayerConverter(thisObj)
{
	...
	rd_BatchLayerConverterData.strDeleteOrigLayer = {
		en: "Delete original layer if new one was created",
		de: "Lösche Ursprungs-Ebenen"
	};
	
	rd_BatchLayerConverterData.strHelp = {en: "?", de: "?"};
	rd_BatchLayerConverterData.strNoCompSel = {en: "Select or open a composition, then try again.", de: "Wähle oder öffne Komposition und versuche es erneut."};
	rd_BatchLayerConverterData.strNoLayerSel = {en: "Select at least one layer, then try again.", de: "Wähle mindestens eine Ebene und versuche es erneut."};
	rd_BatchLayerConverterData.strMinAE110 = {en: "This script requires Adobe After Effects CS6 or later.", de: "Das Skript benötigt mindestens After Effects CS6"};
	rd_BatchLayerConverterData.strHelpText = 
	{
		...
		de: "Copyright (c) 2012-2013 redefinery (Jeffrey R. Almasol).\n" +
